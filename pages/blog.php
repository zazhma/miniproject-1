...
<html lang="en">
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark w3-win8-steel fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link font-weight-bold w3-border-bottom w3-hover-gray badge-pill" href="http://localhost/db_spd/pages/blog.php">Blog <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item active">
        ...
        <div class="container-fluid mt-5 mb-2">
            <div class="card w3-cyan">
                <div class="card-body">
                    <h1 class="card-title text-center">Event</h1>
                    <hr class="bg-light">
                    <div class="row">
                        <div class="col-lg-2">
                            <img class="w-100"src="http://localhost/db_spd/images/event1.png" alt="Foto Event">
                        </div>
                        <div class="col-lg-10">
                            <h3>
                                Gerakan Indonesia 4.0
                            </h3>
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque autem sint odit illo animi saepe sit voluptatibus ea vero, voluptate voluptatum tempore obcaecati ad. Aspernatur, quo? Eum facere nulla reiciendis?
                            </p>
                        </div>
                    </div>
                    <div class="row pt-3">
                        <div class="col-lg-2">
                            <img class="w-100"src="http://localhost/db_spd/images/event3.jpg" alt="Foto Event">
                        </div>
                        <div class="col-lg-10">
                            <h3>
                                Gerakan Indonesia 4.0
                    ...
                    <div class="row pt-3">
                        <div class="col-lg-2">
                            <img class="w-100"src="http://localhost/db_spd/images/event21.jpg" alt="Foto Event">
                        </div>
                        <div class="col-lg-10">
                            <h3>
                                Gerakan Indonesia 4.0
            ...
            <div class="card w3-blue mt-3">
                <div class="card-body">
                    <h1 class="card-title text-center">Beasiswa</h1>
                    <hr class="bg-light">
                    <div class="row">
                        <div class="col-lg-2">
                            <img class="w-75"src="http://localhost/db_spd/images/bea1.png" alt="Foto Event">
                        </div>
                        <div class="col-lg-10">
                            <h3>
                                Gerakan Indonesia 4.0
                    ...
                    <div class="row pt-3">
                        <div class="col-lg-2">
                            <img class="w-100"src="http://localhost/db_spd/images/bea2.png" alt="Foto Event">
                        </div>
                        <div class="col-lg-10">
                            <h3>
                                Gerakan Indonesia 4.0
                    ...
                    <div class="row pt-3">
                        <div class="col-lg-2">
                            <img class="w-100"src="http://localhost/db_spd/images/bea3.png" alt="Foto Event">
                        </div>
                        <div class="col-lg-10">
                            <h3>
                                Gerakan Indonesia 4.0
            ...
            <div class="card w3-indigo mt-3">
                <div class="card-body">
                    <h1 class="card-title text-center">Dokumentasi</h1>
                    <hr class="bg-light">
                    <div class="row text-center">
                        <div class="col-lg-4">
                            <img class="w-50" src="http://localhost/db_spd/images/dok4.jpg" alt="Dokumentasi">
                        </div>
                        <div class="col-lg-4">
                            <img class="w-50" src="http://localhost/db_spd/images/dok9.jpg" alt="Dokumentasi">
                        </div>
                        <div class="col-lg-4">
                            <img class="w-50" src="http://localhost/db_spd/images/dok11.jpg" alt="Dokumentasi">
                        </div>
                    </div>
                    <div class="row mt-3 text-center">
                        <div class="col-lg-4">
                            <img class="w-75" src="http://localhost/db_spd/images/dok2.png" alt="Dokumentasi">
                        </div>
                        <div class="col-lg-4">
                            <img class="w-50" src="http://localhost/db_spd/images/dok1.png" alt="Dokumentasi">
                        </div>
                        <div class="col-lg-4">
                            <img class="w-75" src="http://localhost/db_spd/images/dok3.png" alt="Dokumentasi">
                        </div>
                    </div>
                    <div class="row mt-3 text-center">
                        <div class="col-lg-4">
                            <img class="w-50" src="http://localhost/db_spd/images/dok7.jpg" alt="Dokumentasi">
                        </div>
                        <div class="col-lg-4">
                            <img class="w-50" src="http://localhost/db_spd/images/dok5.jpg" alt="Dokumentasi">
                        </div>
                        <div class="col-lg-4">
                            <img class="w-50" src="http://localhost/db_spd/images/dok10.png" alt="Dokumentasi">
                        </div>
                    </div>
                </div>
            </div>
